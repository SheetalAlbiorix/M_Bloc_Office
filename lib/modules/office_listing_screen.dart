                    ...
                    return Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final colorString = office.color.substring(6,16) ;
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          GestureDetector(
                                            onTap: () {
                                              Navigator.pushNamed(context,
                                                  BaseRoute.officeViewScreen,arguments: state.offices[index]);
                                            },
                                            child: Text(
                                          ...
                                          InkWell(
                                              onTap: () {
                                                Navigator.pushNamed(context,
                                                    BaseRoute.editOfficeScreen,arguments: state.offices[index]);
                                              },
